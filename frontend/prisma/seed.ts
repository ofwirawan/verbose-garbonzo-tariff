...
const countries = [
  ...
  { country_code: "FJI", name: "Fiji", numeric_code: "242", city: "Suva,Fiji" },
  {
    country_code: "FRO",
    name: "Faeroe Islands",
    numeric_code: "234",
  ...
  { country_code: "MAC", name: "Macao", numeric_code: "446", city: "Macau" },
  {
    country_code: "MAR",
    name: "Morocco",
    numeric_code: "504",
  ...
  { country_code: "PER", name: "Peru", numeric_code: "604", city: "Lima,Peru" },
  {
    country_code: "PHL",
    name: "Philippines",
    numeric_code: "608",
  ...
  { country_code: "TGO", name: "Togo", numeric_code: "768", city: "Lome,Togo" },
  {
    country_code: "THA",
    name: "Thailand",
    numeric_code: "764",
  ...
  for (const country of countries) {
    await prisma.country.upsert({
      ...
      update: {
        ...
        city: country.city,
        valuation_basis: country.valuation_basis,
      },
      create: {
