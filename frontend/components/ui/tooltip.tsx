...
function TooltipContent({
  ...
  // Determine arrow color based on background class
  const isWhiteBg = className?.includes("bg-white");
  const arrowClassName = isWhiteBg
    ? "bg-white fill-white z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]"
